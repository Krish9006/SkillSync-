    ...
    <section className="min-h-screen py-32 relative overflow-hidden">
      ...
      <div className="container px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center max-w-5xl mx-auto mb-32">
          ...
          >
            Project Buddies is more than a platform. It's a movement of ambitious students building the future.
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto font-medium">
              Join thousands of students who are already building, learning, and growing on Project Buddies.
            </p>
            <Link href="/signup">
