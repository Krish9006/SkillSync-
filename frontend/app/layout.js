...
export const metadata = {
  ...
  title: "Project Buddies - Build, Collaborate, Ship",
  ...
  openGraph: {
    title: "Project Buddies - Find Your Dream Team",
    ...
    siteName: "Project Buddies",
    images: [
      {
        url: "/opengraph-image.png", // We will need to add this file
        width: 1200,
        height: 630,
        alt: "Project Buddies Dashboard Preview",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Project Buddies - The LinkedIn for Hackathons",
