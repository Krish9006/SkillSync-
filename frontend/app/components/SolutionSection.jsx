                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-lg mb-10 leading-relaxed">
                            SkillSync gives you the network and tools to stop learning alone and start building your career.
                        </p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-black/50 p-4 rounded border border-white/5 text-xs">
                                            <span className="text-signal-purple">import</span> <span className="text-yellow-400">{`{ Mentor }`}</span> <span className="text-signal-purple">from</span> <span className="text-green-400">'@skillsync/core'</span>;
                                            <br /><br />
